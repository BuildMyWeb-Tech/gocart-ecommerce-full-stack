    ...
    <div className="text-slate-500 pt-4 md:p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        {cards.map((card, i) => (
          <div
            key={i}
            className="flex flex-col gap-2 border border-slate-200 p-4 rounded-xl shadow-sm bg-white hover:shadow-md transition-all"
          >
            <div className="flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/sales-report" className="text-xs text-green-600 hover:underline">
              Full Report →
            </Link>
          </div>
            ...
            <div className="space-y-3">
              {data.topStores.map((store, i) => (
                <div key={store.storeId} className="flex items-center gap-3">
                  ...
                  {store.logo && (
                    <img src={store.logo} alt={store.name} className="w-7 h-7 rounded-full object-cover border border-slate-200" />
                  )}
      ...
      <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-semibold text-slate-800 text-base">Sales Analytics (Last 30 Days)</h2>
        </div>
