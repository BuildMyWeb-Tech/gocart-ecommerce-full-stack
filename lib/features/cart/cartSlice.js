  ...
  reducers: {
    addToCart: (state, action) => {
      ...
      if (existing) {
        ...
        // ✅ Update storeId in case it was missing before
        if (product.storeId) existing.storeId = product.storeId;
      } else {
        // ✅ storeId is saved into the cart item here
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(fetchCartThunk.fulfilled, (state, action) => {
        state.loading = false;
        // ✅ items from DB must include storeId — preserved as-is
